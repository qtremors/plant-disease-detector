...
- Include a link to the original repository: `https://github.com/qtremors/plant-disease-detector`
...
```
Based on Plant Disease Detector by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/plant-disease-detector
```
